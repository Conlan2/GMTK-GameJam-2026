...
func _initial_message() -> void:
	_initial_conversation.conversation = [
		...
		{"who": "Phone", "text": "Their new hypersonic strike system can deliver a nuclear strike within 30 seconds of detection."},
		{"who": "Phone", "text": "Your defense battery has been equipped with interception capable missles."},
